...
const translations = {
    'zh-CN': {
        ...
        'usage.time.soon': '即将',
        'usage.time.justNow': '刚刚',
        'usage.time.minutesAgo': '{minutes}分钟前',
        'usage.time.hoursAgo': '{hours}小时前',
        'usage.time.daysAgo': '{days}天前',

        'provider.noProviders': '暂无可用的Provider',
        'provider.switchSuccess': '已切换到 {name}',
        'provider.switchFailed': '切换Provider失败',
        'provider.loadFailed': '加载Provider列表失败',

        'provider.noProviders': 'No available providers',
        'provider.switchSuccess': 'Switched to {name}',
        'provider.switchFailed': 'Failed to switch provider',
        'provider.loadFailed': 'Failed to load provider list',
        ...
        // Test API Page
        'testApi.title': 'API 测试页面',
        'testApi.header': 'AIClient2API 在线测试',
        'testApi.subtitle': '测试 API 连接、认证和聊天功能',
        'testApi.healthCheck': '健康检查',
        'testApi.healthDesc': '检查服务状态和版本信息',
        'testApi.authTest': '认证测试',
        'testApi.authDesc': '测试 API Key 是否有效',
        'testApi.modelsTest': '模型列表',
        'testApi.modelsDesc': '获取可用模型列表',
        'testApi.chatTest': '聊天测试',
        'testApi.chatDesc': '测试聊天 API 功能',
        'testApi.apiKey': 'API Key',
        'testApi.apiKeyPlaceholder': '输入你的 API Key',
        'testApi.model': '模型',
        'testApi.modelPlaceholder': '例如: gpt-4o-mini',
        'testApi.message': '消息内容',
        'testApi.messagePlaceholder': '输入测试消息...',
        'testApi.send': '发送请求',
        'testApi.result': '测试结果',
        'testApi.running': '运行中...',
        'testApi.success': '测试成功',
        'testApi.failed': '测试失败',
        ...
        // Potluck User
        'potluck.title': 'API 大锅饭 - 我的用量',
        'potluck.brand': 'API 大锅饭',
        'potluck.userBadge': '用户版',
        'potluck.welcome': '欢迎，',
        'potluck.logout': '退出',
        'potluck.loginTitle': '登录',
        'potluck.loginSubtitle': '使用您的 API Key 登录查看用量',
        'potluck.apiKeyPlaceholder': 'maki_xxxxxxxx...',
        'potluck.rememberKey': '记住我的 Key',
        'potluck.loginBtn': '登录',
        'potluck.personalStats': '个人使用统计',
        'potluck.lastUsed': '最后使用',
        'potluck.never': '从未',
        'potluck.dailyUsage': '每日用量',
        'potluck.remainingQuota': '剩余额度',
        'potluck.totalCalls': '累计调用',
        'potluck.todayTokens': '今日 Tokens',
        'potluck.todayCachedTokens': '今日缓存 Tokens',
        'potluck.totalTokens': '累计 Tokens',
        'potluck.totalCachedTokens': '累计缓存 Tokens',
        'potluck.usageTrend': '我的使用趋势与分布 (最近 3 个月)',
        'potluck.tokenTrend': '我的 Token 消耗趋势',
        'potluck.topProviders': '常用提供商',
        'potluck.topModels': '常用模型',
        'potluck.times': '{count} 次',
        'potluck.themeToggle': '切换主题',
        'potluck.menu': '菜单',

        // Potluck Admin
        'potluckAdmin.title': 'API 大锅饭 - 管理后台',
        'potluckAdmin.brand': 'API 大锅饭',
        'potluckAdmin.adminBadge': '管理端',
        'potluckAdmin.createKey': '生成新 Key',
        'potluckAdmin.totalKeys': '总 Key 数',
        'potluckAdmin.enabledKeys': '已启用',
        'potluckAdmin.todayCalls': '今日总调用',
        'potluckAdmin.totalCalls': '累计调用',
        'potluckAdmin.todayTokens': '今日总 Tokens',
        'potluckAdmin.todayCachedTokens': '今日缓存 Tokens',
        'potluckAdmin.totalTokens': '累计 Tokens',
        'potluckAdmin.totalCachedTokens': '累计缓存 Tokens',
        'potluckAdmin.usageStats': '节点与 Token 使用统计 (最近 3 个月)',
        'potluckAdmin.tokenCalendar': 'Token 用量日历',
        'potluckAdmin.providerDist': '提供商占比',
        'potluckAdmin.modelDist': '模型活跃度',
        'potluckAdmin.keyList': 'Key 列表',
        'potluckAdmin.searchPlaceholder': '搜索名称或 Key...',
        'potluckAdmin.sortNameAsc': '名称 A-Z',
        'potluckAdmin.sortNameDesc': '名称 Z-A',
        'potluckAdmin.sortUsageDesc': '今日用量 ↓',
        'potluckAdmin.sortUsageAsc': '今日用量 ↑',
        'potluckAdmin.sortTotalDesc': '累计用量 ↓',
        'potluckAdmin.sortLastUsed': '最近使用 ↓',
        'potluckAdmin.sortQps': 'QPS 速率 ↓',
        'potluckAdmin.sortRpm': 'RPM 频率 ↓',
        'potluckAdmin.sortCreated': '创建时间 ↓',
        'potluckAdmin.times': '{count} 次',
    },
    'en-US': {
        // Header
        ...
        'header.buyAccount': 'Buy AI Account',
        ...
        'usage.time.justNow': 'Just now',
        'usage.time.minutesAgo': '{minutes} minutes ago',
        'usage.time.hoursAgo': '{hours} hours ago',
        'usage.time.daysAgo': '{days} days ago',
        ...
        // Test API Page
        'testApi.title': 'API Test Page',
        'testApi.header': 'AIClient2API Online Test',
        'testApi.subtitle': 'Test API connection, authentication and chat functionality',
        'testApi.healthCheck': 'Health Check',
        'testApi.healthDesc': 'Check service status and version info',
        'testApi.authTest': 'Auth Test',
        'testApi.authDesc': 'Test if API Key is valid',
        'testApi.modelsTest': 'Models List',
        'testApi.modelsDesc': 'Get available models list',
        'testApi.chatTest': 'Chat Test',
        'testApi.chatDesc': 'Test chat API functionality',
        'testApi.apiKey': 'API Key',
        'testApi.apiKeyPlaceholder': 'Enter your API Key',
        'testApi.model': 'Model',
        'testApi.modelPlaceholder': 'e.g.: gpt-4o-mini',
        'testApi.message': 'Message',
        'testApi.messagePlaceholder': 'Enter test message...',
        'testApi.send': 'Send Request',
        'testApi.result': 'Test Result',
        'testApi.running': 'Running...',
        'testApi.success': 'Test Successful',
        'testApi.failed': 'Test Failed',
